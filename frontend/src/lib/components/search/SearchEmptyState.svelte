<script lang="ts">
  ...
  let { hasSearchCriteria, onReset }: SearchEmptyStateProps = $props();
</script>
  ...
  <Card>
    <div class="py-10 px-6 text-center">
      <div class="max-w-md mx-auto">
        <div
          class="w-14 h-14 mx-auto mb-4 bg-blue-50 rounded-xl flex items-center justify-center border border-blue-100"
        >
        ...
        <h2 class="text-base font-semibold text-slate-700 mb-2">Ready to search</h2>
...
{:else}
  <Card>
    <div class="py-10 px-6 text-center">
      <div class="max-w-md mx-auto">
        <div
          class="w-14 h-14 mx-auto mb-4 bg-amber-50 rounded-xl flex items-center justify-center border border-amber-100"
        >
        ...
        <h2 class="text-base font-semibold text-slate-700 mb-2">No results found</h2>
        <p class="text-slate-500 mb-6 text-xs leading-relaxed">
