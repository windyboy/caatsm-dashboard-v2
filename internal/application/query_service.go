...
func (s *queryService) Search(ctx context.Context, filter domain.SearchFilter) (*domain.SearchResult, error) {
...
func buildFilterString(filter domain.SearchFilter) string {
	var parts []string
